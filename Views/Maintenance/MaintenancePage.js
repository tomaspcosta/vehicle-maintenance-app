...
export default function HistoryPageView({ navigation, route }) {
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.title}>Next Maintenances! </Text>
  ...
  renderItem={({ item }) => <Component data={item} time={0} carId={carId} carKm={carKm} carImage={carImage} navigation={navigation}/>}
