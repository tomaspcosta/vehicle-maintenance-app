...
import {getComponentAsync} from "../../services";
import { Icon } from "react-native-elements";
import AdminComponent from "../../components/Admin/Component";

export default function AdminComponentView({ navigation}) {
  ...
  useEffect(() => {
    ...
    fetchComponentData();
    const timer = setTimeout(fetchComponentData, 1000);
  ...
  return (
    ...
    <Text style={styles.subtitle}>
        {`${"Name".padStart(5)}${"".padStart(25)}${"Periodicity (Km)".padStart(15)}`}{"\n"}
    </Text>

    <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate("Components Edit", { componentId: 0 })}>
    ...
    <FlatList
        ...
        data={component}
        renderItem={({ item }) => <AdminComponent data={item} navigation={navigation}/>}
